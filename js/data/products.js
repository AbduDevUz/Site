     ...
     ========================================================== */
  {
        ...
        plans: [
          ...
          },
          {
            ...
            highlights: [
              ...
              { label: { uz: "Telegram-bot orqali buyurtma qabul qilish", ru: "Приём заказов через Telegram-бот" }, soon: true },
            ],
          },
        ],
        priceTables: [
    ...
    featureGroups: [
      ...
      },
      {
        ...
        items: [
          { label: { uz: "Agent bevosita omborga buyurtma yuboradi", ru: "Агент отправляет заказ прямо на склад" }, plans: { basic: false, pro: true }, soon: true },
          { label: { uz: "Magazin o'zi buyurtma yuboradi", ru: "Магазин отправляет заказ самостоятельно" }, plans: { basic: false, pro: true }, soon: true },
          { label: { uz: "Magazin buyurtmasi o'sha magazin agentida ham ko'rinadi", ru: "Заказ магазина виден и у агента этого магазина" }, plans: { basic: false, pro: true }, soon: true },
          { label: { uz: "Botda qoldiq va narxni ko'rish", ru: "Просмотр остатков и цен в боте" }, plans: { basic: false, pro: true }, soon: true },
          { label: { uz: "Buyurtmadan bir bosishda chiqim yaratish", ru: "Создание расхода из заказа одним нажатием" }, plans: { basic: false, pro: true }, soon: true },
          { label: { uz: "Buyurtma holati haqida bildirishnoma", ru: "Уведомление о статусе заказа" }, plans: { basic: false, pro: true }, soon: true },
        ],
      },
      {
